...
var HotEngine = class {
	...
	*/
	async predict(input, sessionId, signal) {
		...
		if (isNovel) return this.predictNovel(input, sessionId, signal, oodSignal, top1, successReference, taxonomyContext, adviceSuffix);
	...
	*/
	...
	async predictNovel(input, sessionId, signal, oodSignal, top1, successReference, taxonomyContext, adviceSuffix) {
	...
	async predictKnown(input, samples, sessionId, signal, oodSignal, _top1, successReference, taxonomyContext, adviceSuffix) {
...
//#endregion
export { ACTION_VECTOR_DIM, CognitivePipelineService, Config, OUTCOME_VECTOR_DIM, SYMPTOM_MARKERS, UTILITY_SLOTS, actionVector, apply, cosine, hashToken, inject, isPositiveOutcome, name, normalize, outcomePolarity, outcomeVector, signatureHash, symptomOverlap, tokenize, utilityScore };
