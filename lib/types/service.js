...
import { CognitivePipelineError, deriveReference, evaluateAccumulation, extractSar, resolveRoute } from "./llm.js";
import { cognitionPrefix } from "./prompts.js";
import { CognitiveStore } from "./store.js";
import { actionVector, cosine, outcomeVector, signatureHash, tokenize, utilityScore } from "./vectorizer.js";
...
export class CognitivePipelineService extends Service {
    ...
    async updateAcceptanceCheck(input) {
        ...
        if (criterion === undefined && evidenceHint === undefined) {
            throw new CognitivePipelineError('cognitive-pipeline: update needs criterion, evidenceHint, or retire', 'EMPTY_ACCEPTANCE_UPDATE');
        }
