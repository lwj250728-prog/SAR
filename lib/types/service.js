...
import { CognitivePipelineError, extractSar, resolveRoute } from "./llm.js";
import { cognitionPrefix } from "./prompts.js";
import { CognitiveStore } from "./store.js";
import { actionVector, isPositiveOutcome, outcomeVector, utilityScore } from "./vectorizer.js";
...
export class CognitivePipelineService extends Service {
    ...
    async observedOutcome(input, call) {
        ...
        if (isNeutralUtility(sar.outcomeUtility))
            return 0.5;
